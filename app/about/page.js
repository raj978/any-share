...
import { BrandGithub, ExternalLink } from "lucide-react";
    ...
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-5">
      <div className="max-w-3xl text-center">
        ...
        <p className="text-lg mb-6">
          **Any-Share** is a secure and efficient file-sharing platform that
          allows you to easily upload, manage, and share your files with others.
          Built with modern technologies like Next.js, Firebase, Tailwind CSS,
          and Clerk for seamless authentication, Any-Share ensures your files
